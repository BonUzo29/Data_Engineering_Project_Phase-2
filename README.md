...
`temp_change`: 
Temperature change compared to the previous row.

`cpu_util_change`: 
CPU utilization change compared to the previous row.

`power_efficiency`: 
Power efficiency, which is the ratio of power_draw to cpu_utilization.
